...
import { ServiceOption } from '../../services/calculatorService';

interface ServiceEditModalProps {
  service: ServiceOption | null;
  isOpen: boolean;
  onClose: () => void;
  onSave: (service: ServiceOption, isNew: boolean) => void;
}
...
const ServiceEditModal: React.FC<ServiceEditModalProps> = ({ 
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updatedService: ServiceOption = {
      id,
      name,
      description,
      basePrice,
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input 
              ...
              disabled={!!service} // Cannot edit ID of existing service
          ...
          <div className="mb-4">
            ...
            <input 
              ...
              className={`shadow-sm focus:ring-accent-forest focus:border-accent-forest block w-full sm:text-sm border-gray-300 rounded-md ${
                errors.basePrice ? 'border-red-300' : ''
              }`}
              placeholder="0.00"
            />
            {errors.basePrice && (
          ...
          <div className="mb-6">
            ...
            <p className="mt-1 text-xs text-gray-500">Use an emoji that represents the service</p>
          </div>
