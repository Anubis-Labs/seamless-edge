    ...
    <section id="featured-projects-section" className="w-full py-32 bg-white border-b border-neutral-softgray/10">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="mb-20 text-center max-w-2xl mx-auto">
          ...
          >
            <span className="text-accent-forest text-xs font-heading tracking-[0.2em] uppercase">Our Portfolio</span>
          ...
          >
            <div className="group relative overflow-hidden">
              <div className="relative h-96 overflow-hidden">
                <div className="absolute inset-0 bg-accent-navy/10 group-hover:bg-accent-navy/0 transition-colors duration-700 z-10"></div>
                <img 
                ...
                <div className="absolute top-6 left-6 z-20">
                  <span className="inline-block px-3 py-1 bg-white/90 text-accent-navy text-xs font-heading tracking-wider uppercase">
                    {projects[0].category}
                  </span>
                </div>
              </div>
              
              <div className="p-8 bg-white border-l border-accent-forest">
                <h3 className="text-2xl font-bold font-heading mb-3 text-accent-navy group-hover:text-accent-forest transition-colors duration-500">
                  {projects[0].title}
                </h3>
                
                <div className="w-12 h-px bg-accent-forest mb-4 transition-all duration-500 group-hover:w-16"></div>
                
                <p className="text-accent-navy/70 mb-6 font-body leading-relaxed">
                  {projects[0].description}
                </p>
                
                <Link 
                  to={`/gallery/${projects[0].id}`} 
                  className="inline-flex items-center text-accent-navy font-medium font-heading hover:text-accent-forest transition-all duration-300 group-hover:translate-x-1"
                >
              ...
              >
                <div className="relative h-52 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 z-20">
                    <span className="inline-block px-2 py-1 bg-white/90 text-accent-navy text-xs font-heading tracking-wider uppercase">
                      {project.category}
                    </span>
                  </div>
                </div>
                
                <div className="p-6 bg-white border-l border-accent-forest">
                  <h3 className="text-lg font-bold font-heading mb-2 text-accent-navy group-hover:text-accent-forest transition-colors duration-500">
                    {project.title}
                  </h3>
                  
                  <div className="w-8 h-px bg-accent-forest mb-3 transition-all duration-500 group-hover:w-12"></div>
                  
                  <p className="text-accent-navy/70 mb-4 font-body leading-relaxed text-sm">
                    {project.description}
                  </p>
                  
                  <Link 
                    to={`/gallery/${project.id}`} 
                    className="inline-flex items-center text-accent-navy font-medium font-heading hover:text-accent-forest transition-all duration-300 text-sm group-hover:translate-x-1"
                  >
