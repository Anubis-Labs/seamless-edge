      ...
      <section className="bg-gray-50 py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-primary">Instant Drywall Quote Calculator</h1>
            <p className="text-xl text-gray-700 mb-0 max-w-3xl mx-auto">
              Get an accurate estimate for your drywall project in seconds. 
              Simply enter your project details below for a comprehensive breakdown.
            </p>
          </div>
        </div>
      </section>
