...
const SimpleDatabaseExplorer: React.FC = () => {
  // State
  ...
  // Fetch tables - only use direct query to information_schema
  useEffect(() => {
  ...
  const handleDeleteRecord = async (record: Record) => {
    ...
    try {
      // Find the primary key (assuming 'id')
      const primaryKeyName = 'id'; // This could be improved to find the actual PK
...
export default SimpleDatabaseExplorer; 